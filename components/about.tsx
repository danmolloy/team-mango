...
export default function About() {
  return (
    <section id="about" className="p-4 relative pt-12 flex flex-col min-h-[75vh] pb-32 bg-[#EB5027] text-[#F4F1E0] overflow-hidden">

      <h2 className="self-center z-10 font-semibold text-6xl   text-center ">ABOUT US</h2>
    <div className="flex flex-col items-center md:items-end md:mr-2">
      <div className=" rounded-md items-center  py-8 lg:py-16 pt-8  flex  flex-col   md:self-end">
