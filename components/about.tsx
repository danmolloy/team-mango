...
export default function About() {
  return (
    <section id="about" className="p-4 relative pt-12 flex w-screen flex-col min-h-[75vh] pb-32 bg-dark text-light overflow-hidden">

      <h2 className="self-center z-10 font-semibold text-6xl  tracking-[-4px] text-center ">ABOUT US</h2>
    <div className="flex flex-col items-center md:items-end md:mr-2 lg:w-2/3 lg:self-center mt-8 text-dark">
      <div className=" rounded-md items-center  py-8 lg:py-16 pt-8  flex  flex-col bg-light  md:self-end">
